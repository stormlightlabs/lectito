...
<div class="min-h-screen">
	<SiteHeader active="about" backHref="/" backLabel="← Back to Extract" />
			...
			<main class="space-y-16">
				...
				<section id="rate-limits">
					...
					<p class="mb-6 font-serif text-stone">
						The API enforces per-IP limits across three windows so the public service stays stable under mixed
						interactive and scripted traffic.
					</p>
